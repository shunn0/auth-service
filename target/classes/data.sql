...
INSERT INTO `permissions`(`permission_code`,`description`) VALUES('UPDATE_ROLE', 'Update role');
INSERT INTO `permissions`(`permission_code`,`description`) VALUES('VIEW_ROLES', 'View role list');
INSERT INTO `permissions`(`permission_code`,`description`) VALUES('CREATE_PERMISSION', 'Create new permission');
INSERT INTO `permissions`(`permission_code`,`description`) VALUES('VIEW_PERMISSIONS', 'View permissions list');
...
INSERT INTO `role_permissions`(`role_name`,`permission_code`) VALUES('ADMIN', 'UPDATE_ROLE');
INSERT INTO `role_permissions`(`role_name`,`permission_code`) VALUES('ADMIN', 'CREATE_ROLE');
INSERT INTO `role_permissions`(`role_name`,`permission_code`) VALUES('ADMIN', 'VIEW_ROLES');
INSERT INTO `role_permissions`(`role_name`,`permission_code`) VALUES('ADMIN', 'CREATE_PERMISSION');
INSERT INTO `role_permissions`(`role_name`,`permission_code`) VALUES('ADMIN', 'VIEW_PERMISSIONS');
